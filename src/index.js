...
function getPoem(event) {
  ...
  let context =
    "Imagine that are an eight year old girl and you have an assigment to write a poem that is eight sentences long. Please include only a short literal poem with no more than 8 sentences. Separate each sentence with a <br/>. At the end of the poem, please include an extra <br/> and then sign it using SheCodes AI in a <strong> element ";
